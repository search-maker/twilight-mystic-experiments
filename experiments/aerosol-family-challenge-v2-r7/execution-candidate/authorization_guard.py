...
def validate_enabled_document(
    ...
    require(authorization.get('stageId') == 'aerosol-family-challenge-v2-r7-authorization', 'authorization stage drift')
...
def review(
    ...
    require(context.get('authorizationPath') == 'experiments/aerosol-family-challenge-v2-r7/authorization.json', 'authorization path drift')
