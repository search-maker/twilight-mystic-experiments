...
def validate_enabled_document(
    ...
    require(authorization.get('stageId') == 'aerosol-family-challenge-v2-r8-authorization', 'authorization stage drift')
    ...
    for field, key in (
        ...
        ('dispatchPublisherWorkflowRawSha256', 'dispatchPublisherWorkflow'),
    ):
...
def review(
    ...
    require(context.get('authorizationPath') == 'experiments/aerosol-family-challenge-v2-r8/authorization.json', 'authorization path drift')
