...
AUTHORIZATION_PATH = "experiments/aerosol-family-challenge-v2-r8/authorization.json"
AUTHORIZATION_REVIEW_WORKFLOW = ".github/workflows/aerosol-family-v2-r8-authorization-review.yml"
REQUIRED_MAIN_PATHS = (
...
def _latest_consumed_ordinal(payload: dict[str, Any], candidate_dispatch: str, candidate_ordinal: int) -> int | None:
    values: list[int] = []
    ...
    for comment in payload.get("issue60Comments", []):
        ...
        if match and int(match.group(1)) != int(candidate_ordinal):
...
def build_surface(
    ...
    *,
    ...
    return {
        ...
        "currentConsumedMarkerCount": len(current_consumed_bodies),
        "currentConsumedMarkerBodies": current_consumed_bodies,
