...
CASE_ARTIFACT_PREFIX = "aerosol-family-v2-case-"
AUTHORIZATION_PATH = "experiments/aerosol-family-challenge-v2/authorization.json"
REQUIRED_MAIN_PATHS = (
    "experiments/aerosol-family-challenge-v2/execution-candidate/authorization_guard.py",
    "experiments/aerosol-family-challenge-v2/execution-candidate/dispatch_guard.py",
    "experiments/aerosol-family-challenge-v2/execution-candidate/freshness.py",
    "experiments/aerosol-family-challenge-v2/execution-candidate/guard.py",
    "experiments/aerosol-family-challenge-v2/execution-candidate/executor.py",
    "experiments/aerosol-family-challenge-v2/execution-candidate/transport-contract.v3.json",
    "experiments/aerosol-family-challenge-v2/repository_global_seed_scan.py",
    "experiments/aerosol-family-challenge-v2/tracked_tree_seed_scan.py",
    "experiments/aerosol-family-challenge-v2/merge_seed_proof.py",
    ".github/workflows/aerosol-family-v2-authorization-review.yml",
    ".github/workflows/aerosol-family-v2-execution.yml",
)
