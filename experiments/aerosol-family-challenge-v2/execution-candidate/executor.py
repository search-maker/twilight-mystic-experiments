...
def execute_case(
    ...
    if guard.get('status') != 'EXACT_ONE_USE_AEROSOL_FAMILY_V2_DISPATCH_AUTHORIZED' or guard.get('solverExecutionPermittedNow') is not True:
    ...
    prepared = {
        'schemaVersion': 1,
        'stageId': 'aerosol-family-challenge-v2-prepared',
        'caseId': case_id,
    ...
    result = {
        'schemaVersion': 1,
        'stageId': 'aerosol-family-challenge-v2',
        'status': 'COMPLETED',
        'caseId': case_id,
        'groupId': case['groupId'],
        'analysisCellId': case['analysisCellId'],
