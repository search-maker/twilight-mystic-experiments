...
if git_blob_sha1(BASE) != EXPECTED_BLOB:
    raise RuntimeError("AFPF v1 refuses: bound repository-global scanner bytes changed")
spec = importlib.util.spec_from_file_location("afpf_bound_repository_global_seed_scan", BASE)
if spec is None or spec.loader is None:
    raise RuntimeError("cannot load bound repository-global seed scanner")
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)
mod.REVIEW_PROOF_ARTIFACT_NAME = "afpf-v1-seed-freshness-review-proof"
