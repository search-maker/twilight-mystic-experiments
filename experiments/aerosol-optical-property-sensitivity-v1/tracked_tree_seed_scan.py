...
if git_blob_sha1(BASE) != EXPECTED_BLOB:
    raise RuntimeError("AOPS v1 refuses: bound tracked-tree scanner bytes changed")
spec = importlib.util.spec_from_file_location("aops_bound_tracked_tree_seed_scan", BASE)
