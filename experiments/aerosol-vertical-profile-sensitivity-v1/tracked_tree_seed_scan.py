...
if git_blob_sha1(BASE) != EXPECTED_BLOB:
    raise RuntimeError("vertical-profile v1 refuses: bound tracked-tree scanner bytes changed")
spec = importlib.util.spec_from_file_location("vertical_profile_bound_tracked_tree_seed_scan", BASE)
