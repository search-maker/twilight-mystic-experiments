...
EXPECTED_REPAIR_VALIDATED_HEAD = "fd990dae5007b1a579424bfceb1aa93bb6c2068c"
EXPECTED_REPAIR_MERGED_MAIN = "13fe2e18a7754b893eba31328f90b179fc018499"
...
def validate_smoke_manifest(smoke: dict[str, Any]) -> None:
    ...
    source_required = {
        ...
        "repairValidatedHeadSha": EXPECTED_REPAIR_VALIDATED_HEAD,
        "repairMergedMainSha": EXPECTED_REPAIR_MERGED_MAIN,
        "repairPr": 425,
        "repairValidationRunId": EXPECTED_REPAIR_VALIDATION_RUN,
        "repairValidationArtifactId": EXPECTED_REPAIR_VALIDATION_ARTIFACT,
        "repairValidationArtifactDigest": EXPECTED_REPAIR_VALIDATION_DIGEST,
    }
