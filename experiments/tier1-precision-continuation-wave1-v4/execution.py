...
RUN_TITLE = "Tier-1 precision continuation wave 1 ordinal 10"
AUTHORIZATION_ORDINAL = 10
EXECUTION_KEY = "twilight-surrogate-tier-1-v1:numerical:10"
AUTHORIZATION_PATH = "experiments/tier1-precision-continuation-wave1-v4/authorization.ordinal10.json"
PACKAGE_PATH = "experiments/tier1-precision-continuation-wave1-v4/package.py"
...
def build_manifest(root: Path, auth: dict[str, Any], context: dict[str, Any], runs: list[dict[str, Any]], runtime: dict[str, Any], metadata: dict[str, Any]) -> dict[str, Any]:
    ...
    package = module(root / PACKAGE_PATH, "wave1_v4_execution_package")
    ...
    pages = module(root / PAGES_PATH, "wave1_v4_execution_pages")
...
def aggregate(root: Path, manifest: dict[str, Any], results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    package = module(root / PACKAGE_PATH, "wave1_v4_aggregate_package")
    prereg = package.build_preregistration(root)
...
def audit(root: Path, manifest: dict[str, Any], results: list[dict[str, Any]], aggregate_value: dict[str, Any]) -> dict[str, Any]:
    validate_results(manifest, results)
    package = module(root / PACKAGE_PATH, "wave1_v4_audit_package")
    prereg = package.build_preregistration(root)
...
def analyze(root: Path, manifest: dict[str, Any], aggregate_value: dict[str, Any], audit_value: dict[str, Any]) -> dict[str, Any]:
    validate_manifest(manifest)
    package = module(root / PACKAGE_PATH, "wave1_v4_analysis_package")
    prereg = package.build_preregistration(root)
