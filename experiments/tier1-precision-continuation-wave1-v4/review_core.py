...
SEED_PLAN_PATH = "evidence/tier1-precision-continuation-wave1-v4/seed-plan.json"
DUPLICATE_SNAPSHOT_PATH = "evidence/tier1-precision-continuation-wave1-v4/ordinal10-duplicate-search-snapshot.json"
SOURCE_MAIN_SHA = "811f9e773b21dbecf9e63d10bd42df22889d7ff6"
V3_PREREGISTRATION_SHA256 = "9517d15623ef7b9e08f5b3d3a2e0ec5702f634755eb9851a2afe761810d4cd67"
CONSUMED_ORDINAL9_RUN = 31_048_812_892
CONSUMED_ORDINAL9_JOB = 92_450_886_111
CONSUMED_ORDINAL9_REF = "18f1abdb014dc00f5ef4583b0ccbcf5bad8f2a28"
CONSUMED_ORDINAL9_KEY = "twilight-surrogate-tier-1-v1:numerical:9"
CONSUMED_ORDINAL9_TITLE = "Tier-1 precision continuation wave 1 ordinal 9"
CANDIDATE_ORDINAL = 10
CANDIDATE_KEY = "twilight-surrogate-tier-1-v1:numerical:10"
CANDIDATE_TITLE = "Tier-1 precision continuation wave 1 ordinal 10"
CANDIDATE_BRANCH = "authorization/tier1-precision-continuation-wave1-ordinal10-v4"
CANDIDATE_AUTHORIZATION_PATH = "experiments/tier1-precision-continuation-wave1-v4/authorization.ordinal10.json"
STAGE_ID = "tier1-precision-continuation-wave1-preregistration-v4"
WAVE = 1
BLOCKS = (3, 4)
CASE_COUNT = 40
GEOMETRY_COUNT = 20
...
def seed_plan(root: Path) -> dict[str, Any]:
    ...
    required = {
        "schemaVersion": 1,
        "stageId": "tier1-precision-continuation-wave1-v4-seed-plan",
        "status": "REVIEW_ONLY_NOT_AUTHORIZATION",
        "sourceMainSha": SOURCE_MAIN_SHA,
        "replacesConsumedOrdinals": [8, 9],
        "replacesConsumedRuns": [31_044_664_420, CONSUMED_ORDINAL9_RUN],
...
def proposal(root: Path):
    plan = seed_plan(root)
    base = load_module(root / BASE_PACKAGE_PATH, "tier1_continuation_v4_patched_base")
    ...
    wave_v2 = load_module(root / V2_WAVE_PACKAGE_PATH, "tier1_wave1_v2_source_for_v4")
