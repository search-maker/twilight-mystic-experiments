...
STAGE_ID='public-tier2-v1-core-stage1-execution-v1'; BRANCH_RE=re.compile(r'^dispatch/tier2-stage1-ordinal[1-9][0-9]*-v1$'); HIST_REL=Path('experiments/full-spectrum-estimator-pilot-v2/executor.py')
