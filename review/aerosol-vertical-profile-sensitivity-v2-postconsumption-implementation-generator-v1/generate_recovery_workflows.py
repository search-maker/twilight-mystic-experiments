...
OLD = {
    'auth_branch': 'authorization/aerosol-vertical-profile-sensitivity-v2-ordinal-41',
    'auth_head': 'd5f5e4d9d19d7ede573fecae68565a92baabbec3',
    'auth_parent': 'b3d562222a38fc9d1ff5d218886afdda72c37fa2',
    'auth_pr': "AUTH_PR: '604'",
    'review_run': "AUTH_REVIEW_RUN: '33218101573'",
    'review_artifact': "AUTH_REVIEW_ARTIFACT: '9704345296'",
    'review_digest': 'sha256:fdabe0425c3de893866c25f14b0da1e0038a8e6498b83a281fcae0e773e605d4',
    'dispatch': 'dispatch/aerosol-vertical-profile-sensitivity-v2-ordinal-41',
    'key': 'aerosol-vertical-profile-sensitivity-v2:numerical:41',
    ...
    'seed': '02f624d582e9b2caba6b920d65a5e8a8bc8fc1a2693623bc2f73abf5d3f706d2',
}
NEW = {
    'auth_branch': 'authorization/aerosol-vertical-profile-sensitivity-v2-postconsumption-recovery1-ordinal-42',
    'auth_head': 'e627a689ada0493a8a5b9cdafc4aba0198fbabec',
    'auth_parent': 'a68f603d6da21cd28ab8324da080cc8ad27f9094',
    'auth_pr': "AUTH_PR: '629'",
    'review_run': "AUTH_REVIEW_RUN: '33250602685'",
    'review_artifact': "AUTH_REVIEW_ARTIFACT: '9714316591'",
    'review_digest': 'sha256:083d7127a1591810870875d1b6c15f795c1fee0996c1dadaec5838b785bce8c2',
    'dispatch': 'dispatch/aerosol-vertical-profile-sensitivity-v2-postconsumption-recovery1-ordinal-42',
    'key': 'aerosol-vertical-profile-sensitivity-v2-postconsumption-recovery1:numerical:42',
    'allocation': 'ORDINAL42_AVPS_V2_POSTCONSUMPTION_RECOVERY1_AUTHORIZATION_ALLOCATED_REVIEWED_NOT_DISPATCHED commit=e627a689ada0493a8a5b9cdafc4aba0198fbabec parent=a68f603d6da21cd28ab8324da080cc8ad27f9094 pr=629',
    'consumed': 'ORDINAL42_AVPS_V2_POSTCONSUMPTION_RECOVERY1_DISPATCH_CONSUMED',
    'seed': 'a514212990a94a39d577bd038b631a600e18e4c0f750f781bbd7c99b897228a7',
}
...
def science() -> str:
    t = common(SCIENCE_SRC.read_text())
    ...
    for token in (OLD['auth_branch'], OLD['dispatch'], OLD['consumed'], OLD['seed'], 'scientificOrdinal\':41'):
        if token in t:
...
def publisher() -> str:
    t = common(PUBLISHER_SRC.read_text())
...
def bridge(publisher_blob: str) -> str:
    ...
    t = must(t, 'avps-v2-dispatch-publisher-recovery2.yml', PUBLISHER_OUT)
    t = must(t, '79317065f4a6019c19fdbf8ab81ea4b4952ef868', publisher_blob)
    t = must(t, 'dispatch-trigger/aerosol-vertical-profile-sensitivity-v2-ordinal-41-publisher-recovery2', 'dispatch-trigger/aerosol-vertical-profile-sensitivity-v2-postconsumption-recovery1-ordinal-42-publisher')
    t = must(t, 'dispatch-triggers/avps-v2-ordinal41-publisher-recovery2.txt', 'dispatch-triggers/avps-v2-postconsumption-recovery1-ordinal42-publisher.txt')
    t = must(t, "SCIENTIFIC_ORDINAL: '41'", "SCIENTIFIC_ORDINAL: '42'")
    t = must(t, "'scientificOrdinal':41", "'scientificOrdinal':42")
