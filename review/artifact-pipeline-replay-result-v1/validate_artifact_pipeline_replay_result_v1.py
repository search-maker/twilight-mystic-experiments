...
EXPECTED_RESULT='41f225b49986c3d177a46a327228e32c8c1ceeaf64fdf1fef0519b75974d6783'
ZERO=['tier1-wave1-ordinal11-case-train-0013-precision-continuation-wave1-v1-b3','tier1-wave1-ordinal11-case-train-0013-precision-continuation-wave1-v1-b4','tier1-wave2-ordinal12-case-train-0013-precision-continuation-wave2-v1-b5','tier1-wave2-ordinal12-case-train-0013-precision-continuation-wave2-v1-b6']
...
def validate(d):
    ...
    f=d['candidateFiles']; req(f['artifact-pipeline-replay-attestation.json']=={'rawSha256':'6d8efb581ea7efb7ba06a8d17b03a98286c4ca2559963020d10655728928c69a','sizeBytes':3170} and f['training-handoff-replay.json']=={'rawSha256':'43bfd5248726db97faaeda1f0b9cc59ff83e39365618979430839217789d699d','sizeBytes':165327} and f['transport-manifest.json']=={'rawSha256':'55111ab382dc5e04961a416130238531bfd6349ceb70a58f17ce54a5f9a3aeb5','sizeBytes':232409},'candidate files')
    at=d['attestation']; req(at['attestationSha256']=='0623a4b9ce3441e633dbae79fef61a32a15e8900efa27739645b4febf74c1d9f' and at['replayHeadSha']=='dda9170a902b04b365d3602484b01b3dfac34528','attestation identity')
