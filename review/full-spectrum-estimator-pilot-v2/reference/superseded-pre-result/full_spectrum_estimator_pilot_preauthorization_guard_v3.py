...
CONTRACT = ROOT / 'full-spectrum-estimator-pilot-preauthorization-contract-v3.json'
...
def validate_static() -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    require(
        contract.get('contractId') == 'public-tier1-full-spectrum-estimator-pilot-preauthorization-contract-v3',
...
def evaluate(ctx: dict[str, Any]) -> dict[str, Any]:
    ...
    if mode == 'PRE_AUTHORIZATION':
        ...
        return {
            'schemaVersion': 1,
            'guardId': 'public-tier1-full-spectrum-estimator-pilot-preauthorization-guard-v3',
