...
The preserved run `32805147882` gives the final v1 continuous-AOD status under the preregistered resource limits. Ten of the 11 grid-supported pairs are continuously certified over AOD550 0.05–0.40, and all 10/10 remain outside the certified modeled union in the same direction: observed ln(L6/L3) is more negative than the model. The one non-certified pair is Z=90 degrees, P=30 degrees, elevation 30 m. It reached the frozen `maxNodes=500000` resource cap (`branchNodes=500388`, maximum depth reached 16 of allowed 50, 1373 partition breakpoints); its recorded interval gaps were still at most 4.603e-5 versus the frozen 1e-4 tolerance, but the unexplored branches prevent a certification claim. The frozen 1001-point diagnostic for that same pair remains outside in the same more-negative direction by about 0.1325 mag equivalent. It is therefore recorded as numerically inconclusive under the v1 resource cap, not as a physical reversal. No node-cap, tolerance, support, partition, or stop-rule relaxation is made after seeing this result.

The exact result provenance is retained in `KOOMEN_1952_SHAPE_CONTINUOUS_AOD_RUN_32805147882_RESULT.review.json`: source artifact id 9548153777, artifact ZIP SHA-256 `221e21023d19c12c0d5723afff95d639fbb63425b13168135442e7e62adf78ba`, and continuous-result raw SHA-256 `627f834ffb626270185141865b6937e28be1a9b4916be5c7a84aa5ecc18e890a`.
