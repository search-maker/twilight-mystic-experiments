...
WORKFLOW = ROOT / ".github/workflows/avps-v1-dispatch-publisher.yml"
...
class AvpsPostConsumptionPublisherRecovery(unittest.TestCase):
    ...
    def test_recovery_control_commit_must_be_direct_child_of_live_main(self):
    ...
    def test_recovered_publisher_artifact_matches_frozen_science_contract(self):
        required = (
